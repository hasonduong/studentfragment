...
class MainActivity : AppCompatActivity() {
  ...
  val students = mutableListOf(
    StudentModel("Hà Sơn Dương", "20215554"),
    StudentModel("Đỗ Thành Đạt", "20215555"),
    StudentModel("Từ Văn An", "20215556"),
    StudentModel("Quách Đình Dương", "20215557"),
    StudentModel("Vũ Văn Hảo", "20215558")
  )
